...
// 使用 reactive 对象来管理 OAuth 状态，确保响应式更新
...
async function openAccountModal() {
  ...
  oauthState.checking = true;
  oauthState.googleConfigured = false;
  ...
  try {
    ...
    if (response.ok) {
      ...
      oauthState.googleConfigured = googleEnabled;
      console.log('[AppHeader] OAuth configured:', oauthState.googleConfigured);
    }
  } catch (err) {
      ...
      <div class="account-modal-body">
        ...
        <div class="account-modal-field">
          ...
          <span class="account-modal-hint" v-if="selectedPreset === 'Gmail'">
            <button type="button" class="google-login-btn" @click="loginWithGoogle" :disabled="!oauthState.googleConfigured">
